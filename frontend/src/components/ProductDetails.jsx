...
const ProductDetails = () => {
  ...
  return (
    <div
      ...
      }  flex flex-col justify-start pt-[3rem] items-center w-full bg-center   bg-gradient-to-l from-gray-300 bg-[var(--bg-color)] to-[75%]  h-full flex-grow   duration-[1s]  transition-all "`}
    >
